# Generated by Django 3.2 on 2026-04-29 14:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True)),
                ('status', models.CharField(choices=[('PLANNED', 'Запланировано'), ('IN_PROGRESS', 'В работе'), ('ON_REVIEW', 'На проверке'), ('DONE', 'Готово')], default='PLANNED', max_length=20)),
